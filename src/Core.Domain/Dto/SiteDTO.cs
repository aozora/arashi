...
namespace Arashi.Core.Domain.Dto
{
   ...
   public class SiteDTO
   {
      ...
      //public virtual bool AllowRegistration
      //{
      //   get;
      //   set;
      //}
      //public virtual bool AllowPasswordRetrieval
      //{
      //   get;
      //   set;
      //}
      ...
      //   set;
      //}
      //public virtual Page DefaultPage
      //{
      //   get;
      //   set;
      //}
      ...
      //   set;
      //}
      //public virtual SiteStatus Status
      //{
      //   get;
      //   set;
      //}
      ...
      //// Post Settings
      //public virtual int MaxPostsPerPage
      //{
      //   get;
      //   set;
      //}
      //public virtual int MaxSyndicationFeeds
      //{
      //   get;
      //   set;
      //}
      //public virtual bool FeedUseSummary
      //{
      //   get;
      //   set;
      //}
      ...
      //// Comment Settings
      //public virtual bool AllowPings
      //{
      //   get;
      //   set;
      //}
      ...
      //   set;
      //}
      //public virtual bool AllowCommentsOnlyForRegisteredUsers
      //{
      //   get;
      //   set;
      //}
      //public virtual int MaxCommentsPerPage
      //{
      //   get;
      //   set;
      //}
      //public virtual bool SortCommentsFromOlderToNewest
      //{
      //   get;
      //   set;
      //}
      //public virtual bool SendEmailForNewComment
      //{
      //   get;
      //   set;
      //}
      //public virtual bool SendEmailForNewModeration
      //{
      //   get;
      //   set;
      //}
      //public virtual bool ShowAvatars
      //{
      //   get;
      //   set;
      //}
      //public virtual int MaxLinksInComments
      //{
      //   get;
      //   set;
      //}
      //public virtual string ModerationKeys
      //{
      //   get;
      //   set;
      //}
      //public virtual string BlacklistKeys
      //{
      //   get;
      //   set;
      //}
      //public virtual bool EnableCaptchaForComments
      //{
      //   get;
      //   set;
      //}
      //public virtual string CaptchaPrivateKey
      //{
      //   get;
      //   set;
      //}
      //public virtual string CaptchaPublicKey
      //{
      //   get;
      //   set;
      //}
      ...
      //   set;
      //}
      //public virtual SeoSettings SeoSettings
      //{
      //   get;
      //   set;
      //}
      ...
      //// Collections
      //public virtual IList<SiteHost> Hosts
      //{
      //   get;
      //   set;
      //}
      ...
      public override int GetHashCode()
      {
         unchecked
         {
            int result = this.SiteId.GetHashCode();
            result = 29 * result;
            return result;
         }
      }
