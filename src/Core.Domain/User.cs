...
namespace Arashi.Core.Domain
{
   ...
   /// </summary>
   //[PropertiesMustMatch("Password", "PasswordConfirmation", ErrorMessage = "Password doesn't match confirmation, please check it.")]
   public class User : IPrincipal, IIdentity
   {
      ...
      public virtual String ExternalProviderUri { get; set; }
      ...
      /// </summary>
      /// <remarks>
      /// Note: this property don't have any dataannotation attribute
      /// </remarks>
      ...
      /// <summary>
      /// Default editor for html page in control panel
      /// </summary>
      public virtual Editor AdminEditor { get; set; }
