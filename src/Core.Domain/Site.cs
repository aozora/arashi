...
namespace Arashi.Core.Domain
{
   ...
   public class Site
   {
      ...
      public virtual string GoogleDataUserName { get; set; }
      public virtual string GoogleDataPassword { get; set; }
      public virtual string GoogleDataProfileID { get; set; }
      ...
      public virtual IList<SiteFeature> Features { get; set; }
      ...
      //public virtual IList<SiteOption> Options { get; set; }
