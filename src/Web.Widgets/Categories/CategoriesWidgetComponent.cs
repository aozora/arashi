...
namespace Arashi.Web.Widgets.Categories
{
   public class CategoriesWidgetComponent : WidgetComponentBase
   {
      ...
      private static readonly ILog log = LogManager.GetLogger(typeof(CategoriesWidgetComponent ));
      ...
      public CategoriesWidgetComponent(ILocalizationService localizationService, ICategoryService categoryService)
      {
