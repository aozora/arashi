...
namespace Arashi.Web.Widgets.Archives
{
   ...
   public class ArchivesWidgetComponent : WidgetComponentBase
   {
      ...
      private static readonly ILog log = LogManager.GetLogger(typeof(ArchivesWidgetComponent));
      ...
      public ArchivesWidgetComponent(IContentItemService<Post> contentItemService)
      {
