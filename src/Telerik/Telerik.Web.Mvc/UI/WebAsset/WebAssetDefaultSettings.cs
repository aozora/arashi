...
namespace Telerik.Web.Mvc
{
   ...
   using System.Web;
    ...
    public static class WebAssetDefaultSettings
    {
        ...
        static WebAssetDefaultSettings()
        {
           NameValueCollection section = (NameValueCollection)ConfigurationManager.GetSection("telerik");
           styleSheetFilesPath = section["cssPath"];
           scriptFilesPath = section["jsPath"];
           compress = Convert.ToBoolean(section["EnableSoftwareCompression"]);

           bool isDebuggingEnabled = (HttpContext.Current != null) && HttpContext.Current.IsDebuggingEnabled;
           bool combineIfDebuggingEnabled = Convert.ToBoolean((section["CombineIfDebuggingEnabled"]));

           combined = (isDebuggingEnabled && !combineIfDebuggingEnabled) ? false : true;
        }
