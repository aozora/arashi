...
namespace Arashi.Core.Util
{
   ...
   public sealed class TimeZoneUtil
   {
      ...
      /// </summary>
      /// <param name="dt"></param>
      /// <param name="timeZone">The value of User.TimeZone</param>
      /// <returns></returns>
      public static DateTime AdjustDateToTimeZone(DateTime dt, int timeZone)
      {
         return dt.AddMinutes(timeZone - GetMachineTimeZoneOffset());
      }
      ...
      /// </summary>
      /// <param name="dt"></param>
      /// <param name="userTimeZone">The value of User.TimeZone</param>
      /// <returns></returns>
