...
namespace Arashi.Core.Extensions
{
   public static class CommonExtensions
   {
      ...
      /// <summary>
      /// Convert a DateTime to a Javascript Timestamp (that is a number)
      /// </summary>
      ...
      /// <summary>
      /// Return an empty string if the source is null, or the given source.ToString()
      /// </summary>
      /// <param name="s"></param>
      /// <returns></returns>
      public static string ToEmptyStringIfNull(this object s)
      {
      ...
      /// <returns></returns>
      public static T[] ToObjectArray<T>(this T obj)
      {
         return new[]
			       	{
			       		obj
      ...
      public static string Append(this String value, string valueToAppend)
      {
         ...
         return Append(value, valueToAppend.ToObjectArray());
      }
