...
{
   public class AdminViewUserControlBase : ViewUserControl
   {
      ...
      /// Constructor
      /// </summary>
      public AdminViewUserControlBase()
      {
   ...
   public class AdminViewUserControlBase<TModel> : ViewUserControl<TModel>
      where TModel : class
   {
      private ILocalizationService localizationService;
