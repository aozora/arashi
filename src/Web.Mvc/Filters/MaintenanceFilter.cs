namespace Arashi.Web.Mvc.Filters
{
   ...
   {
      private static readonly ILog log = LogManager.GetLogger(typeof(MaintenanceFilter));
      private string view;
      ...
      public override void OnActionExecuting(ActionExecutingContext filterContext)
      {
         ...
         if (currentSite != null)
         {
            ...
            Template currentTemplate = currentSite.Template;
            int httpStatusCode = 302;

            //if (currentSite.Status == SiteStatus.Offline)
            //   httpStatusCode = 503;

            //if (File.Exists(filterContext.HttpContext.Server.MapPath(currentTemplate.BasePath + "/302_sitedown.aspx")))
            //   viewPath = currentTemplate.BasePath + "/302_sitedown.aspx";
