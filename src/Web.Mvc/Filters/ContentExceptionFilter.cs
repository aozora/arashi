...
namespace Arashi.Web.Mvc.Filters
{
   ...
   {
      private static readonly ILog log = LogManager.GetLogger(typeof(ContentExceptionFilter));
      ...
      public override void OnException(ExceptionContext filterContext)
      {
         ...
         if (filterContext.Controller != null)
         {
            ...
            if (controllerBase != null)
            {
               ...
               {
                  currentTemplate = context.CurrentSite.Template;

                  if (File.Exists(filterContext.HttpContext.Server.MapPath(currentTemplate.BasePath + "/error.aspx")))
                     viewPath = currentTemplate.BasePath + "/error.aspx";
               }
            }
         }
