...
namespace Arashi.Web.Mvc.Paging
{
   public class Pager
   {
      ...
      private readonly string queryStringName = "page";
      ...
      public string RenderHtml()
      {
         ...
         {
            sb.Append(GeneratePageLink("&laquo; First", start));
         }
         ...
         if (end < pageCount)
         {
            sb.Append(GeneratePageLink("Last &raquo;", nrOfPagesToDisplay));
         }
      ...
      private string GeneratePageLink(string linkText, int pageNumber)
      {
         ...
         pageLinkValueDictionary.Add(queryStringName, pageNumber);
