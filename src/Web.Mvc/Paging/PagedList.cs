...
namespace Arashi.Web.Mvc.Paging
{
   public class PagedList<T> : List<T>, IPagedList<T>
   {
      ...
      public PagedList(IEnumerable<T> source, int index, int pageSize, long? totalCount)
      {
      ...
      public PagedList(IQueryable<T> source, int index, int pageSize, long? totalCount)
      {
      ...
      protected void Initialize(IQueryable<T> source, int index, int pageSize, long? totalCount)
      {
         //### argument checking
         if (index < 0)
         {
