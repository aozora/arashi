...
namespace Arashi.Web.Mvc.Paging
{
   public static class PagingExtensions
   {
      ...
      public static string Pager(this HtmlHelper htmlHelper, int pageSize, int currentPage, long totalItemCount)
      {
         return Pager(htmlHelper, pageSize, currentPage, totalItemCount, null, null);
      }

      public static string Pager(this HtmlHelper htmlHelper, int pageSize, int currentPage, long totalItemCount, string actionName)
      {
         return Pager(htmlHelper, pageSize, currentPage, totalItemCount, actionName, null, null);
      }

      public static string Pager(this HtmlHelper htmlHelper, int pageSize, int currentPage, long totalItemCount, object values)
      {
         return Pager(htmlHelper, pageSize, currentPage, totalItemCount, null, new RouteValueDictionary(values), null);
      }

      public static string Pager(this HtmlHelper htmlHelper, int pageSize, int currentPage, long totalItemCount, string actionName, object values)
      {
         return Pager(htmlHelper, pageSize, currentPage, totalItemCount, actionName, new RouteValueDictionary(values), null);
      }

      public static string Pager(this HtmlHelper htmlHelper, int pageSize, int currentPage, long totalItemCount, RouteValueDictionary valuesDictionary)
      {
         return Pager(htmlHelper, pageSize, currentPage, totalItemCount, null, valuesDictionary, null);
      }

      public static string Pager(this HtmlHelper htmlHelper, int pageSize, int currentPage, long totalItemCount, string actionName, RouteValueDictionary valuesDictionary, string queryStringName)
      {
