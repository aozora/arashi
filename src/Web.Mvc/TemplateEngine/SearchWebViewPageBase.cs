...
namespace Arashi.Web.Mvc.TemplateEngine
{
   ...
   /// </summary>
   public abstract class SearchWebViewPageBase<TModel> : ThemeWebViewPageBase<TModel>
      where TModel : TemplateContentModel
   {
      ...
      protected override IHtmlString next_posts_link(string label)
      {
      ...
      protected override IHtmlString previous_posts_link(string label)
      {
         if (string.IsNullOrEmpty(label))
