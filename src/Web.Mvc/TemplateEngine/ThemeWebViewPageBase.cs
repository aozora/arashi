namespace Arashi.Web.Mvc.TemplateEngine
{
   ...
   /// <summary>
   /// Base class for all theme files.
   /// Must have access to all entities
   /// </summary>
   public abstract partial class ThemeWebViewPageBase<TModel> : WebViewPage<TModel>
      where TModel : TemplateContentModel
   {
      ...
      protected ThemeWebViewPageBase()
      {
      ...
      /// <summary>
      /// Get the virtual path to the specified vied for the Theme of the current site
      /// </summary>
      /// <param name="templateFile"></param>
      /// <returns></returns>
      public string GetViewVirtualPath(ViewHelper.TemplateFile templateFile)
      {
         if (Model.Site.Theme != null)
         {
            return string.Concat(Model.Site.Theme.BasePath,
                                 "/",
      ...
      /// Without the_post(), many of the Theme Tags used in your theme would not work
      /// 
