...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
	...
	<div id="setupbox" class="section ui-widget">
		<div id="setupbox-inner" class="ui-widget-content ui-corner-all ui-shadow">
            ...
            <asp:Panel ID="PrerequisitesPanel" runat="server" Visible="false">
					<ul id="setup-steps" class="block-align" >
						<li class="current">
							<div class="ui-widget-header">
								<img src="/Resources/img/48x48/check.png" alt="check" />
								<span>Step 1</span>
							</div>
						</li>
						<li>
					...
					<div id="step-content" class="block-align">
						...
						<p>Before installing, we need to check if the application has the necessary permissions to write files and if the connection to the database is correct. Please click on the <strong>Check</strong> button below:</p>
						<div class="align-center">
							<asp:Button ID="PrerequisitesCheckButton" runat="server" 
											CssClass="button ui-state-default ui-priority-primary ui-corner-all"
											Text="Check" 
											OnClick="PrerequisitesCheckButton_Click">
							</asp:Button>
						</div>
						<br />
						<asp:Label ID="lblCheckResults" runat="server" Font-Bold="True"></asp:Label>
						<br />
						<br />
						<div class="align-center">
							<asp:Button ID="GoToStep2Button" runat="server" Enabled="false" 
											CssClass="button ui-state-default ui-priority-primary ui-corner-all"
											Text="Next &gt;" 
											OnClick="GoToStep2Button_Click">
							</asp:Button>
						</div>
						<br />
					</div>
				...
				<asp:Panel ID="DatabasePanel" runat="server" Visible="False">
					...
					<div id="step-content" class="block-align">
						...
						<br />
						<p>The database for the following components will be installed:</p>
					...
					<div id="step-content" class="block-align ui-form-default">
						...
						<ol>
							...
							<li class="vertical">
								...
								<asp:RegularExpressionValidator ID="PasswordMinLengthValidator" runat="server"
																	 CssClass="field-validation-error" 
																	 EnableClientScript="False" 
																	 ControlToValidate="EmailTextBox" 
																	 Display="Dynamic" 
																	 ErrorMessage="The password length must be at minimum of 8 chars"
							...
							<li class="vertical">
								...
								<asp:RequiredFieldValidator ID="ConfirmPasswordRequiredFieldValidator" runat="server" 
																	 ...
																	 Display="Dynamic" 
																	 ErrorMessage="The password is required" />
								<asp:RegularExpressionValidator ID="ConfirmPasswordMinLengthValidator" runat="server"
																	 CssClass="field-validation-error" 
																	 EnableClientScript="False" 
																	 ControlToValidate="ConfirmPasswordTextBox" 
																	 Display="Dynamic" 
																	 ErrorMessage="The password confirmation length must be at minimum of 8 chars"
																	 ValidationExpression=".{8}.*" />
