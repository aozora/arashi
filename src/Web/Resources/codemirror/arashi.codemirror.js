...
function createToolbar(){
   ...
   var $media = $("<a id='addMediaLink' class='media' href='#'><span>" + localized_Editor_AddMedia + "</span></a>");
   var $more = $("<a id='addMoreLink' class='more' href='#'><span>" + localized_Editor_More + "</span></a>");
