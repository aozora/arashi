...
java -jar ..\..\..\..\..\Tools\YUICompressor\build\yuicompressor.jar --charset utf-8 -o jquery.notify.min.js         jquery.notify.js
...
java -jar ..\..\..\..\..\Tools\YUICompressor\build\yuicompressor.jar --charset utf-8 -o xVal.jquery.validate.min.js  xVal.jquery.validate.js
