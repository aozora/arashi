...
namespace Arashi.Web.Areas.Admin.Extensions
{
   public static class ButtonExtensions
   {
      ...
      /// <returns></returns>
      public static string SubmitUI(this HtmlHelper helper, string text)
      {
      ...
      /// <returns></returns>
      public static string SubmitUI(this HtmlHelper helper, string text, string cssClass)
      {
      ...
      /// <param name="text"></param>
      /// <returns></returns>
      public static string SubmitUI(this HtmlHelper helper, UIButtonType buttonType, string text)
      {
         return String.Format("<button type=\"{0}\" class=\"button ui-shadow\" >{1}</button>", buttonType.ToString().ToLower(), text);
      }


      public static string SubmitUI(this HtmlHelper helper, UIButtonType buttonType, string text, string cssClass)
      {
         return String.Format("<button type=\"{0}\" class=\"button ui-shadow {2}\" >{1}</button>", buttonType.ToString().ToLower(), text, cssClass);
      }
      ...
      /// <returns></returns>
      public static string ActionLinkUI(this HtmlHelper helper, 
                                          string linkText, 
                                          string actionName, 
