...
namespace Arashi.Services
{
   ...
   public class DatabaseInstaller
   {
      ...
      private System.Version currentVersionInDatabase;
      ...
      /// </summary>
      public System.Version CurrentVersionInDatabase
      {
         get
         {
      ...
      /// </summary>
      public System.Version NewAssemblyVersion
      {
         get
         {
      ...
      public void Upgrade()
      {
         if (CanUpgrade)
         {
            ...
            foreach (System.Version version in this.upgradeScriptVersions)
            {
      ...
      private bool CheckCanUpgrade()
      {
         if (this.assembly != null)
         {
            if (this.currentVersionInDatabase != null && this.upgradeScriptVersions.Count > 0)
            {
               ...
               System.Version highestScriptVersion = (System.Version)this.upgradeScriptVersions[this.upgradeScriptVersions.Count - 1];
