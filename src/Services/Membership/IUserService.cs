...
namespace Arashi.Services.Membership
{
	...
	public interface IUserService
   {
      ...
      ///// <summary>
      ///// Crea un nuovo user sul sito Admin con ruolo ServiceAdmin; viene anche creato 
      ///// un nuovo customer, figlio del customer d'origine
      ///// </summary>
      ///// <param name="email"></param>
      ///// <param name="clearPassword"></param>
      ///// <param name="parentCustomer"></param>
      ///// <returns></returns>
      //User CreateUserWithServiceAdministratorRole(string email, string clearPassword, Customer parentCustomer, Site site);
