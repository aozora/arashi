...
namespace Arashi.Services.Notification
{
   ...
   {
      public MessageService(Arashi.Core.NHibernate.ISessionFactory sessionFactory, ILog log)
      ...
      {
         return Session.GetNamedQuery("GetQueuedEmailMessages").SetMaxResults(maxMessagesToRetrieve)
                           .List<Message>();
